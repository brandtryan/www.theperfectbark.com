...
start_time(line0WordAnimations[0], lineDuration0, wordArray0.length, 10);
start_time(line0WordAnimations[1], lineDuration0, wordArray0.length, 18);

line0WordAnimations[1].onfinish = (event) => {
  console.log("Animations Finished: " + document.timeline.currentTime)
};
...
console.log("ln0w10 duration = " + line0WordAnimations[0].effect.getTiming().duration);
console.log("ln0w18 duration = " + line0WordAnimations[1].effect.getTiming().duration);
console.log("ln0w10 startTime = " + line0WordAnimations[0].startTime);
console.log("ln0w18 startTime = " + line0WordAnimations[1].startTime);
console.log("ln0w10 WHOLE duration = " + overall_duration(line0WordAnimations[0]))
console.log("ln0w18 WHOLE duration = " + overall_duration(line0WordAnimations[1]))
